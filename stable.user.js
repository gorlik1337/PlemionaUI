...
(function() {
    if (localStorage['GorlikUI'] == undefined){
        localStorage['GorlikUI'] = JSON.stringify({"enableScavenge": false, "valueScavenge": 0, "showSupport": true, "showSettings": true, "enableScaling": false, "autoRaportDelete": false});
    }
...
if (document.URL.includes('screen=overview')){
    /*Bierzące parametry dopisz Populacje*/
...
// zamkniecie konstruktora
    ...
    document.getElementById('rightcolumn').prepend(pole); // top right
